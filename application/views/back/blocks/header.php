...
<div class="br-sideleft overflow-y-auto">
    ...
    <div class="br-sideleft-menu">
      ...
      <?php if ($this->uri->segment(2) == 'dashboard') {
        ...
        <a href="<?php echo base_url(); ?>panel/layout_elements" class="br-menu-link 
      <?php if ($this->uri->segment(2) == 'layout_elements') {
            echo 'active';
        } ?>">
            <div class="br-menu-item">
                <i class="menu-item-icon icon fas fa-th-large tx-20"></i>
                <span class="menu-item-label">Elementy layoutu</span>
            </div>
        </a>

        <?php $links = ['Lista' => 'promotional_actions']; ?>
        <a href="#" class="br-menu-link
    <?php if (in_array($this->uri->segment(2), $links)) {
        echo 'show-sub';
    } ?>">
            <div class="br-menu-item">
                <i class="menu-item-icon icon fas fa-percentage tx-20"></i>
                <span class="menu-item-label">Akce promocyjne</span>
    ...
    <?php if (in_array($this->uri->segment(2), $links)) {
        echo 'show-sub';
            ...
            <div class="br-menu-item">
                ...
                <span class="menu-item-label">Warto wiedzieć</span>
                <i class="menu-item-arrow fa fa-angle-down"></i>
            </div>
        </a>
        <ul class="br-menu-sub nav flex-column">
        ...
        <?php $links = ['Opis firmy' => 'about', 'Atrybuty' => 'attributes', 'Atrybuty tło' => 'attributes_bg', 'Jesteś zainteresowany?' => 'interested']; ?>
        <a href="#" class="br-menu-link
    <?php if (in_array($this->uri->segment(2), $links)) {
        echo 'show-sub';
    } ?>">
        ...
        <?php $links = ['Przyciski kontaktowe' => 'header_buttons', 'Przyciski social media' => 'social_buttons', 'Slider' => 'slider']; ?>
        <a href="#" class="br-menu-link
    <?php if (in_array($this->uri->segment(2), $links)) {
        echo 'show-sub';
    } ?>">
        ...
        <?php $links = ['Kategorie produktów' => 'products', 'Produkty' => 'sub_products', 'Marki' => 'brands', 'Opisy' => 'products_desc', 'Kolory' => 'colors', 'Pasek pod<br>pojedynczym produktem' => 'product_section_below']; ?>
        <a href="#" class="br-menu-link
    <?php if (in_array($this->uri->segment(2), $links)) {
        echo 'show-sub';
    } ?>">
        ...
        <?php $links = ['Kategorie' => 'realizations', 'Opisy' => 'realizations_desc']; ?>
        <a href="#" class="br-menu-link
    <?php if (in_array($this->uri->segment(2), $links)) {
        echo 'show-sub';
    } ?>">
        ...
        <?php $links = ["Kategorie dokumentów" => 'downloads_categories', 'Dokumenty' => 'downloads', 'Opisy' => 'downloads_desc',]; ?>
        <a href="#" class="br-menu-link
    <?php if (in_array($this->uri->segment(2), $links)) {
        echo 'show-sub';
    } ?>">
            <div class="br-menu-item">
                ...
                <span class="menu-item-label">Do pobrania</span>
                <i class="menu-item-arrow fa fa-angle-down"></i>
            </div>
        </a>
        <ul class="br-menu-sub nav flex-column">
        ...
        <?php $links = ['Lista' => 'brands', 'Opisy' => 'brands_desc']; ?>
        <a href="#" class="br-menu-link
    <?php if (in_array($this->uri->segment(2), $links)) {
        echo 'show-sub';
    } ?>">
            <div class="br-menu-item">
                <i class="menu-item-icon icon fas fa-copyright tx-20"></i>
                <span class="menu-item-label">Marki</span>
                <i class="menu-item-arrow fa fa-angle-down"></i>
            </div>
        </a>
        <ul class="br-menu-sub nav flex-column">
        ...
        <?php $links = ['Lista' => 'news', 'Opisy' => 'news_desc']; ?>
        <a href="#" class="br-menu-link
    <?php if (in_array($this->uri->segment(2), $links)) {
        echo 'show-sub';
    } ?>">
    ...
    <?php if (in_array($this->uri->segment(2), $links)) {
        ...
        <?php $links = ['Opisy' => 'contact_desc', 'Pracownicy' => 'employees']; ?>
        <a href="#" class="br-menu-link
    <?php if (in_array($this->uri->segment(2), $links)) {
        echo 'show-sub';
    } ?>">
        ...
        <a href="<?php echo base_url(); ?>panel/towns" class="br-menu-link
    <?php if ($this->uri->segment(2) == 'towns') {
        echo 'active';
    } ?>">
            <div class="br-menu-item">
                <i class="menu-item-icon icon fas fa-map-pin tx-20"></i>
                <span class="menu-item-label">Dla Regionu</span>
            </div>
        </a>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="contact" role="tabpanel">
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="regon" name="regon" onchange="updateField('regon' , 'contact_settings')"
                        value="<?php echo @$contact->regon; ?>"
                        class="form-control form-control-inverse transition pd-y-10">
                </div>
            </div>
