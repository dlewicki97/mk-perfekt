                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="<?php echo base_url(); ?>panel/settings/gallery/<?php echo $this->uri->segment(2); ?>/<?php echo $value->id; ?>"
                                    class="btn btn-sm btn-info"><i class="icon ion-images mg-r-10"></i> Galeria</a>
                                <a href="<?php echo base_url(); ?>panel/technical_data/list/<?php echo $value->id; ?>"
                                    class="btn btn-sm btn-secondary"><i class="fas fa-list mg-r-10"></i> Lista</a>
                                <a href="<?php echo base_url(); ?>panel/<?php echo $this->uri->segment(2) . "/form/update/$value->id"; ?>"
