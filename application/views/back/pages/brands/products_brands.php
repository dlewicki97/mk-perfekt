    ...
    <div class="br-mainpanel">
        <div class="pd-30">
            <h4 class="tx-gray-800 mg-b-5">Lista marek dla kategorii: <?= $product->title ?></h4>
            <p class="mg-b-0"><?php echo subtitle(); ?></p>
            <a href="<?php echo base_url("panel/products"); ?>" class="btn btn-sm btn-info mt-2"><i
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a href="<?php echo base_url("panel/brands/brands__sub_products/{$this->uri->segment(4)}/$value->id"); ?>"
                                    class="btn btn-sm btn-info"><i class="icon ion-compose mg-r-10"></i> Lista
                                    produktów</a>
