    ...
    <div class="br-mainpanel">
      <div class="pd-30">
        ...
        <p class="mg-b-0"><?php echo subtitle().$town_id; ?></p>
        <hr>
      </div><!-- d-flex -->
                    ...
                    <div class="row"> <!-- set -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force">
                                ...
                                <select class="browser-default custom-select w-100" name="town_id">
                                <?php foreach($towns AS $key): ?>
                                    <option value="<?= $key->id ?>" <?php if($key->id==$town_id){
                                echo "selected";}?>><?= $key->title ?></option>
                                <?php endforeach; ?>
                                </select>
                            </div>
                        </div><!-- col-4 -->
                    ...
                    <div class="row"> <!-- set -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force bd-b-0-force">
                                <label class="form-control-label">Opis przy zdjęciu:</label>
