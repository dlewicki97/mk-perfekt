    ...
    <div class="br-mainpanel">
        <div class="pd-30">
            <h4 class="tx-gray-800 mg-b-5">Kategorie produktów</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-t-0-force" style="overflow-x: hidden;">
                                    <label class="form-control-label">Wybierz marki: <a
                                            href="<?= base_url('panel/brands') ?>">
                                            Dodaj nową markę</a></label>
                                    <select class="form-control select2-show-search " multiple name="brands[]">
                                        <?php foreach ($brands as $brand) : ?>
                                        <option
                                            <?php if (is_brand_selected($brand->id, @$value->id)) echo 'selected'; ?>
