    ...
    <div class="br-mainpanel">
        <div class="pd-30">
            ...
            <?php $offer = $this->back_m->get_one('sub_products', $sub_product->id) ?>
            <a href="<?php echo base_url(); ?>panel/sub_products" class="btn btn-sm btn-info mt-3"><i
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="wd-50p text-right no-sort">
                                <a href="<?php echo base_url(); ?>panel/<?php echo $this->uri->segment(2); ?>/form/insert/<?= $sub_product->id ?>"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a href="<?php echo base_url(); ?>panel/<?php echo $this->uri->segment(2); ?>/form/update/<?php echo "$sub_product->id/$value->id"; ?>"
