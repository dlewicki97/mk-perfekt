    ...
    <div class="br-mainpanel">
        <div class="pd-30">
            <h4 class="tx-gray-800 mg-b-5">Kategorie dokumentów</h4>
            ...
            <form class="form-layout form-layout-2"
                ...
                <div class="row no-gutters">
                            ...
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-r-0-force bd-t-0-force">
                                    ...
                                    <input class="form-control" type="text" name="subtitle"
                                        value="<?php echo @$value->subtitle; ?>" required>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            <div id="photoViewer_1" class="form-group  bd-b-1-force bd-t-0-force ">
