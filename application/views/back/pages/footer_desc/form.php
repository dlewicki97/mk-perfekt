          ...
          <form class="form-layout form-layout-2" action="<?php echo base_url(); ?>panel/<?php echo $this->uri->segment(2); ?>/action/<?php echo $this->uri->segment(4) . '/' . $this->uri->segment(2); ?>/<?php echo @$value->id; ?>" method="post"  enctype="multipart/form-data">
            ...
            <div class="row no-gutters">
                    ...
                    <div class="row"> <!-- set -->
                        ...
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-l-0-force bd-r-0-force">
                                <label class="form-control-label">Napis obok przycisków social media:</label>
                                <input class="form-control" type="text" name="buttons_name" value="<?php echo @$value->buttons_name; ?>">
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-md-6 pr-0">
                            <div class="form-group bd-t-0-force">
                                <label class="form-control-label">Wskazówki dojazdu: </label>
                        ...
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-t-0-force bd-l-0-force bd-r-0-force">
                                <label class="form-control-label">Link do wskazówek dojazdu:</label>
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                        <div class="form-group  bd-t-0-force ">
                            <label class="form-control-label">Tło linków:</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group bd-t-0-force ">
                            <label class="form-control-label">Pomarańczowy romb:</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group bd-t-0-force ">
                            <label class="form-control-label">Tło AD AWARDS:</label>
