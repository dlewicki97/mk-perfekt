                ...
                <div class="row no-gutters">
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-6 pr-0">
                                <div class="form-group bd-t-0-force">
                                    <label class="form-control-label">Dostępne kolory: </label>
                                    <input class="form-control" type="text" name="colors"
                                        value="<?php echo @$value->colors; ?>">
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-md-6 px-0">
                                <div class="form-group bd-t-0-force bd-l-0-force bd-r-0-force">
                                    <label class="form-control-label">Dane techniczne: </label>
                                    <input class="form-control" type="text" name="technical_data"
                                        value="<?php echo @$value->technical_data; ?>">
                                </div>
                            </div><!-- col-4 -->
                        </div> <!-- set -->
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            <div class="form-group  bd-t-0-force ">
                                <label class="form-control-label">Tło listy na stronie głównej:</label>
                        ...
                        <div class="col-md-12">
                            <div id="photoViewer_2" class="form-group text-center delete_photo cursor"
                                onclick="clear_box(2);">
                                <?php if (@$value->photo2 != '') {
                        ...
                        <div class="col-md-12">
                            <div class="form-group bd-t-0-force ">
                                <label class="form-control-label">Tło kafelka po najechaniu kursorem:</label>
                        ...
                        <div class="col-md-12">
                            <div id="photoViewer_3" class="form-group text-center delete_photo cursor"
                                onclick="clear_box(3);">
                                <?php if (@$value->photo3 != '') {
                        ...
                        <div class="col-md-12">
                            <div class="form-group bd-t-0-force ">
                                <label class="form-control-label">Tło przycisku:</label>
                                <input type="hidden" id="name_photo_3" name="name_photo_3">
                                <button type="button" class="btn btn-info white w-100"
                                    onclick="openModal(3);">Dodaj</button>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div id="photoViewer_3" class="form-group bd-b-0-force bd-t-0-force">
                                <label class="form-control-label">Tekst alternatywny zdjęcia:</label>
                                <input class="form-control" type="text" name="alt3"
                                    value="<?php echo @$value->alt3; ?>">
                            </div>
                        </div>

                        <div class="col-md-12">
                            <div id="photoViewer_4" class="form-group text-center delete_photo cursor"
                                onclick="clear_box(4);">
                                <?php if (@$value->photo4 != '') {
                        ...
                        <div class="col-md-12">
                            <div class="form-group bd-t-0-force ">
                                <label class="form-control-label">Ikona przycisku:</label>
                                <input type="hidden" id="name_photo_4" name="name_photo_4">
                                <button type="button" class="btn btn-info white w-100"
                                    onclick="openModal(4);">Dodaj</button>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div id="photoViewer_4" class="form-group bd-t-0-force">
                                <label class="form-control-label">Tekst alternatywny zdjęcia:</label>
                                <input class="form-control" type="text" name="alt4"
                                    value="<?php echo @$value->alt4; ?>">
                            </div>
                        </div>
                    </div>
                </div><!-- row -->
