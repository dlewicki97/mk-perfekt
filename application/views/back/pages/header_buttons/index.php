            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle"><?= substr(strip_tags($value->button_name), 0, 70); if(strlen($value->button_name) > 70) echo '...' ?></td>
                  <td class="text-right">
                      ...
                      onclick="return confirm('Czy na pewno chcesz usunąć <?php echo $value->button_name; ?>? #<?php echo $value->id; ?>')" >
