...
class Mailer extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        if (!verify_captcha($_POST['token'])) {
            $this->session->set_flashdata('flashdata', '<div role="alert" class="alert mb-0 alert-danger alert-dismissible"><p class="text-danger font-weight-bold mb-0">Proszę zaznaczyć recaptchę!</p>
<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
    ...
    public function send()
    {
        ...
        $insert['subject'] = 'Formularz kontaktowy - ' . $insert['email'];
