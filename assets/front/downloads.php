...
<head>
	...
	<title>Pliki do pobrania - MK Perfekt</title>
	...
	<header>
		<div class="position-relative">
			...
			<div class="banner lazy" data-bg="img/banner-downloads.png">
				<div class="mask"></div>
				<h3>Do pobrania</h3>
				<p>Instrukcje obsługi, katalogi i inne</p>
			</div>
					...
					<div class="col-12 col-lg-6 <?php if($i%2==0) echo 'pr-0 pr-lg-3'; else echo 'pl-0 pl-lg-3' ?>">
						<div class="download-container">
							<div class="icon-container">
								<img class="lazy" data-src="img/file.svg" alt="plik">
							</div>
							<div class="download-content position-relative">
								<div class="download-titles-container">
									<div class="download-title">Semmelrock</div>
									<div class="download-subtitle">Fugdio - piaski</div>
								</div>
								<div class="mask"></div>
								<div class="d-flex">
									<div class="download-size">2468 KB</div>
									<div class="download-button">
										<svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18"><g><g><g><path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="20" stroke-width="2" d="M17.28 11.562v3.552c0 .981-.795 1.777-1.776 1.777H3.07a1.776 1.776 0 0 1-1.777-1.777v-3.552 0"/></g><g><path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="20" stroke-width="2" d="M4.846 7.12v0l4.441 4.442v0l4.441-4.441v0"/></g><g><path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="20" stroke-width="2" d="M9.287 11.562V.903"/></g></g></g></svg>
									</div>
								</div>
							</div>
						</div>
