...
<head>
	...
	<title>Kontakt - MK Perfekt</title>
...
<body>
	...
	<header>
		<div class="position-relative">
			...
			<div class="banner lazy" data-bg="img/banner-downloads.png">
				<div class="mask"></div>
				<h3>Kontakt</h3>
	...
	<main class="bg-picture lazy" data-bg="img/main-bg.jpg">
		<div class="d-flex flex-wrap contact-form-row">
			<img class="lazy contact-scroll" data-src="img/scroll.svg" alt="">
			<div class="col-12 col-lg-6 contact-form-col">
				<h2 class="contact-title">MK Perfekt</h2>
				<div class="contact-block">
					<div class="contact-block-img-container">
						<img class="lazy" data-src="img/pin.svg" alt="">
					</div>
					<div class="contact-block-text"><a href="https://www.google.com/maps/place/Przemys%C5%82owa+1s,+59-300+Lubin/@51.376667,16.187734,17z/data=!4m5!3m4!1s0x470f6f1717b1f7c5:0xe8a91065bd546736!8m2!3d51.3766667!4d16.1877344?hl=pl" class="account-link">Przemysłowa 1S, 59-300 Lubin</a></div>
				</div>
				<div class="contact-block">
					<div class="contact-block-img-container">
						<img class="lazy" data-src="img/phone.svg" alt="">
					</div>
					<div class="contact-block-text"><a class="account-link" href="tel:+48 791 100 451">+48 791 100 451</a></div>
				</div>
				<div class="contact-block">
					<div class="contact-block-img-container">
						<img class="lazy" data-src="img/mail.svg" alt="">
					</div>
					<div class="contact-block-text"><a href="mailto:mk.perfekt@o2.pl" class="account-link">mk.perfekt@o2.pl</a></div>
				</div>
				<div class="contact-block">
					<div class="contact-block-img-container">
						<img class="lazy" data-src="img/building.svg" alt="">
					</div>
					<div class="contact-block-text">NIP: 6922302913</div>
				</div>
				<div class="contact-block">
					<div class="contact-block-img-container">
						<img class="lazy" data-src="img/building.svg" alt="">
					</div>
					<div class="contact-block-text">REGON: 362775611</div>
				</div>


				<div class="d-flex flex-wrap">
					<div class="col-12 col-md-6 text-center">
						<img class="lazy account-avatar" data-src="img/account.png" alt="">
						<h5 class="account-name">Mariusz Pępkowski</h5>
						<div style="line-height: 20px">
							<a class="account-link" href="tel:+48 791 100 451">+48 791 100 451</a>
							<a class="account-link" href="mailto:mk.perfekt@o2.pl">mk.perfekt@o2.pl</a>
						</div>
					</div>

					<div class="col-12 col-md-6 text-center">
						<img class="lazy account-avatar" data-src="img/account.png" alt="">
						<h5 class="account-name">Karol Stępniewicz</h5>
						<div style="line-height: 20px">
							<a class="account-link" href="tel:+48 724 581 945">+48 724 581 945</a>
							<a class="account-link" href="mailto:mk.perfekt@o2.pl">mk.perfekt@o2.pl</a>
						</div>
					</div>
				</div>

				<h2 class="contact-title text-left section-title">Formularz kontaktowy.</h2>
				<p>Masz pytania? Wypełnij poniższy formularz!</p>
				...
				<div class="d-flex flex-wrap" style="margin-top: 2rem">
					<div class="g-recaptcha" data-sitekey="6Lc--kYaAAAAADAS9GG1eUWYUNA2z_-i5_LAlqRS"></div>
					<div class="d-flex justify-content-start justify-content-lg-end w-100">
						<div>
							<button class="button first text-hover">WYŚLIJ</button>
						</div>
					</div>
				</div>
			...
			<div class="col-12 col-lg-6 map-column">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2490.4356913112156!2d16.185545715302993!3d51.37667002807495!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x470f6f1717b1f7c5%3A0xe8a91065bd546736!2sPrzemys%C5%82owa%201s%2C%2059-300%20Lubin!5e0!3m2!1spl!2spl!4v1612273136734!5m2!1spl!2spl" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
			</div>
		</div>
	</main>
