...
<head>
	...
	<title>Single Produkt - MK Perfekt</title>
...
<body>
	...
	<header>
		<div class="position-relative">
			...
			<div class="banner lazy" data-bg="img/banner-single-product.png">
				<div class="mask"></div>
				<h3>Ogrodzenia modułowe ROMA Classic</h3>
				<p>Joniec</p>
			</div>
		...
		<section class="single-product">
			<div class="d-flex flex-wrap">
				<div class="col-12 col-lg-6">
					<div class="bg-picture lazy single-product-photo" data-bg="img/single-product-1.png">
						<div class="mask"><img class="lazy" data-src="img/magnify.svg" alt="lupa"></div>
					</div>
				</div>

				<div class="col-12 col-lg-6 px-0 px-lg-5">
					<h3 class="single-product-title">Nowy wymiar ogrodzenia.</h3>
					<div class="single-product-description">
						<p>Nowoczesne ogrodzenie betonowe <strong>ROMA Classic</strong> to produkt, który doskonale wpasowuje się w aktualne trendy w budownictwie. <strong>Prostota i elegancja</strong> ogrodzenia idealnie współgrają z nowoczesną architekturą domów. Elementy systemu ROMA Classic dają szerokie spektrum zastosowań: od klasycznych ogrodzeń z niską podmurówką i wąskimi słupkami, po bardziej okazałe ogrodzenia z szerokimi słupkami i podwyższoną podmurówką, aż po mury, które umożliwiają całkowite odgrodzenie posesji od uciążliwości pochodzących z zewnątrz. Ogromną zaletą ogrodzenia ROMA Classic jest <strong>prosty i szybki montaż, co znaczącą obniża koszty oraz skraca czas budowy.</strong></p>
					</div>
				</div>
				...
				<div class="col-12 col-lg-6 mt-3">
					<div class="d-flex flex-wrap single-product-gallery">
						<?php $j=0; for($i=2 ; $i<8 ; $i++): ?>
						<div class="col-4 <?php if($j==0) echo 'pl-0'; elseif($j==2) echo 'pr-0';  ?>">
							<div class="bg-picture lazy single-product-photo gallery" data-bg="img/single-product-<?= $i ?>.png">
								<div class="mask"><img class="lazy" data-src="img/magnify.svg" alt="lupa"></div>
							</div>
						</div>
						<?php if($j==2) $j=0; else $j++; endfor; ?>
					</div>
				</div>

				<div class="col-12 col-lg-6 px-0 px-lg-5 mt-3 align-items-center d-flex">
					<div class="single-product-description ">
						<p>Bloczki ogrodzeniowe ROMA Classic mogą być także użyte, jako elementy małej architektury ogrodowej, np. jako donice lub obrzeża klombów. Jest to także doskonały materiał do wznoszenia elewacji ścian zewnętrznych budynków.</p>
						<p></p>
						<p>Ogrodzenie ROMA Classic zostało wyróżnione medalem Targów DOM Kielce 2016, Znakiem Jakości HOME ZONE - Jakość i Niezawodność 2016 oraz Złotym Medalem Międzynarodowych Targów Poznańskich 2018.</p>
					</div>
				</div>
				...
				<div class="d-flex flex-wrap w-100 mt-5">
					<div class="col-12 col-lg-6">
						...
						<div class="d-flex flex-wrap">
							<?php $colors = ['Gagat', 'Onyx', 'Topaz']; for($i=0 ; $i<3 ; $i++): ?>
							<div class="col-4 <?php if($i==0) echo 'pl-0'; elseif($i==2) echo 'pr-0';  ?>">
								<div class="bg-picture lazy single-product-photo gallery" data-bg="img/single-product-color-<?= $i+1 ?>.png">
									<div class="mask"><img class="lazy" data-src="img/magnify.svg" alt="lupa"></div>
								</div>
								<div class="single-product-color-title mt-1"><?= $colors[$i] ?></div>
							</div>
						<?php endfor; ?>
					</div>
				</div>
				<div class="col-12 col-lg-6 px-0 px-lg-5 mt-5 mt-lg-0">
					<h3 class="single-product-title">Dane techniczne:</h3>

					<div class="single-product-table">
						<div class="single-product-table-row">
							<div>Szerokość:</div>
							<div><strong>4,5 m</strong></div>
						</div>

						<div class="single-product-table-row">
							<div>Wysokość:</div>
							<div><strong>1,6 m</strong></div>
						</div>

						<div class="single-product-table-row">
							<div>Głębokość:</div>
							<div><strong>0,3 m</strong></div>
						</div>
					</div>
				</div>
	...
	<section class="like-product">
		<div class="bg-picture lazy" data-bg="img/like-product-bg.png">
			<div class="mask"></div>
