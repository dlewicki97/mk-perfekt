...
<head>
	...
	<title>Galeria - MK Perfekt</title>
...
<body>
	...
	<header>
		<div class="position-relative">
			...
			<div class="banner lazy" data-bg="img/banner-gallery.png">
				<div class="mask"></div>
				<h3>Zainspiruj się</h3>
				<p>Fotogaleria naszych realizacji</p>
			</div>
	...
	<main class="bg-picture lazy" data-bg="img/main-bg.jpg">
			...
			<div class="d-flex flex-wrap">
				<?php for($i=0 ; $i<16 ; $i++): ?>
					<div class="col-lg-3 p-0">
						<a class="ad-lightbox" href="img/gallery-<?= $i+1 ?>.png">
							<div class="bg-picture lazy" data-bg="img/gallery-<?= $i+1 ?>.png">
		...
		<section class="ad-lightbox-modal">
			<div class="ad-lightbox-gallery">
				<?php for($i=0 ; $i<16 ; $i++): ?>
					<img class="ad-lightbox-img" src="img/gallery-<?= $i+1 ?>.png" alt="img">
				<?php endfor; ?>
				
			</div>
			<img class="ad-lightbox-arrow ad-lightbox-arrow-left" onclick="prev()" src="img/arrow-left.svg" alt="lewo">
			<img class="ad-lightbox-arrow ad-lightbox-arrow-right" onclick="next()" src="img/arrow-right.svg" alt="lewo">
		</section>
	...
	<script>
		...
		let transformValue = ($(document).width() - document.getElementsByClassName('ad-lightbox-img')[0].getBoundingClientRect().width) / 2;

		function setGalleryPosition() {
			let transform = document.getElementsByClassName('ad-lightbox-img')[0].getBoundingClientRect().width + 48 - transformValue;
			document.getElementsByClassName('ad-lightbox-gallery')[0].style.transform = `translateX(calc(-${transform * index}px - ${transformValue}px * ${index} + ${transformValue}px))`;
		...
		document.getElementsByClassName('ad-lightbox-modal')[0].addEventListener('click',e => {
			if(e.toElement.classList.contains('ad-lightbox-modal') || e.toElement.classList.contains('ad-lightbox-gallery')) {
